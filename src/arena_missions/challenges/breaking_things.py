...
def register_breaking_things_challenges(enable_color_variants: bool = True) -> None:
    ...
    receptacles = [
        ...
        *required_object_builder.main_office_desks(),
        ...
        RequiredObject(name=ObjectInstanceId.parse("MissionItemHolder_1"), roomLocation=["Lab1"]),
        RequiredObject(name=ObjectInstanceId.parse("MissionItemHolder_1"), roomLocation=["Lab2"]),
    ]
